...
void sendListMovies()
{
    ...
    sendInt(socketfd, num); // Sending total number of movies
...
void sendListCinemas()
{
    ...
    sendInt(socketfd, num); // Sending total number of cinemas
...
void sendListSeats()
{
    ...
    fseek(fptr, 0, SEEK_SET); // Setting pointer at the starting index of file
    char ch;
    int i = 0;
    int temp[12];
    int dtemp[12] = {0};
